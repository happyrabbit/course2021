...
output: 
  slidy_presentation: 
    footer: "https://course2021.scientistcafe.com/"
---
...
- Your local machine ( [vignette](https://scientistcafe.com/ids/r/ch12dnn), [rmd](https://raw.githubusercontent.com/happyrabbit/linhui.org/gh-pages/IDS/R/Ch12DNN.Rmd)): Different versions of Python may cause some errors when running `install_keras()`. Here are the things you could do when you encounter the Python backend issue in your local machine.
