...
![](images/vgg16.png){width=70%}


# Classic CNNs: ResNets

- ResNets: He et al., 2015. [Deep Residual Learning for Image Recognition](https://arxiv.org/pdf/1512.03385.pdf)

![](images/ResNet.png){width=80%}
