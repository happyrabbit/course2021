...
- **Information Gain**: $Entropy=-plog_{2}p-(1-p)log_{2}(1-p)$
...
$p_c$ is the proportion of samples in category $c$. 

# IG v.s IGR

<center>
![](../../../IntroDataScience/images/infogainratioexp.png){width=70%}

![](../../../IntroDataScience/images/infogainratioexp2.png){width=70%}
</center>
